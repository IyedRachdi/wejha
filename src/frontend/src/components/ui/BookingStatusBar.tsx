...
import type { BookingStatus } from "@/types/wejha";
...
export function BookingStatusBar({ status, className }: BookingStatusBarProps) {
  ...
  return (
    <div
      ...
      aria-label={`Statut: ${STEPS[currentIndex]?.label}`}
    >
