import { r as reactExports, j as jsxRuntimeExports, R as React, c as cn, e as reactDomExports, f as ReactDOM, g as create, p as persist, u as useAuthStore } from "./index-Cs24hTMk.js";
...
const Accessibility = createLucideIcon("accessibility", __iconNode$b);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function applyAttributes(textSize, highContrast) {
...
function useAccessibility() {
  const { textSize, highContrast, setTextSize, toggleHighContrast } = useAccessibilityStore();
  return { textSize, highContrast, setTextSize, toggleHighContrast };
}
function useAuth() {
  return useAuthStore();
}
function useMockBookings() {
  return [
    {
      id: "b-001",
      pmrId: "u-001",
      providerId: "u-010",
      serviceType: "medical",
      description: "Accompagnement au rendez-vous médical à la clinique El Manar",
      status: "confirmed",
      scheduledAt: Date.now() + 2 * 60 * 60 * 1e3,
      createdAt: Date.now() - 30 * 60 * 1e3,
    ...
    },
    {
      ...
      status: "completed",
      scheduledAt: Date.now() - 2 * 24 * 60 * 60 * 1e3,
  ...
  return [
    {
      ...
      scheduledAt: Date.now() + 3 * 60 * 60 * 1e3,
      isUrgent: false
    },
    {
      id: "m-002",
      ...
      scheduledAt: Date.now() + 24 * 60 * 60 * 1e3,
      isUrgent: false
    },
    {
      id: "m-003",
    ...
    },
    {
      id: "m-004",
      category: "transport",
      description: "Transport urgent — fauteuil roulant vers les urgences de Charles Nicolle",
      pointsReward: 200,
      durationMinutes: 45,
      payoutAmount: 50,
      address: "Boulevard du 9 Avril, Tunis",
      scheduledAt: Date.now() + 30 * 60 * 1e3,
      isUrgent: true
    },
    {
      id: "m-005",
      category: "medical",
      description: "Prise de médicaments à la pharmacie et livraison à domicile",
      pointsReward: 60,
      durationMinutes: 30,
      payoutAmount: 15,
...
const pmrTabs = [
  { key: "home", label: "Accueil", icon: House, route: "/home" },
...
function TabBar({ role, activeTab, onTabChange }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-stretch max-w-lg mx-auto", children: tabs.map((tab) => {
        const Icon = tab.icon;
...
function AppLayout({
  ...
  const effectiveRole = roleProp ?? userRole ?? "pmr";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "fixed top-0 left-0 right-0 z-50 bg-primary text-primary-foreground shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 max-w-lg mx-auto h-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl tracking-tight", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        showSos && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Accessibility, { className: "w-5 h-5", "aria-hidden": "true" })
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "main",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto w-full", children })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TabBar,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: accessOpen, onOpenChange: setAccessOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SheetContent,
      {
        side: "bottom",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { className: "flex flex-row items-center justify-between pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-lg font-bold", children: "Accessibilité" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pt-4 pb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-foreground/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-5 h-5 text-foreground", "aria-hidden": "true" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-base font-semibold", children: "Contraste élevé" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Améliore la lisibilité" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-foreground/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Type,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-base font-semibold", children: "Taille du texte" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Ajustez selon votre confort" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: ["small", "medium", "large"].map((size) => {
                const labels = {
                  small: "Petit",
                  medium: "Normal",
                  large: "Grand"
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: cn(
                      ...
                      textSize === size ? "bg-primary text-primary-foreground border-primary" : "bg-card border-border text-foreground hover:bg-muted"
                    ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-4 rounded-xl bg-secondary/10 border border-secondary/20", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Volume2,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Support vocal" }),
                " — Activez le lecteur d'écran de votre appareil pour la navigation vocale."
              ] })
            ] })
          ] })
        ]
...
export {
  ...
  X,
  useMockBookings as a,
  useMockProviders as b,
  ...
  Switch as j,
  useMockMissions as k,
  Slot$1 as l,
  Primitive$1 as m,
  useAccessibility as n,
  Type as o,
  Calendar as p,
  useAuth as u
};
